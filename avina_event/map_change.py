...
def map_description():
    ...
    if get_map() == 132:
        ...
        speak("Whisp-like creatures seem to float and flow through the sky, almost as if dancing.")
        ...
        time.sleep(8)
        speak("He walks over to another, a teenage girl, and touches her on the shoulder.")
        time.sleep(20)
        speak("After looking at each other for a few moments, the teenager climbs a small hill and looks out into the distance.")
    elif get_map() == 368:
        ...
        time.sleep(5)
        speak("A few moments later, a child appears in the same place, fading in and out of view.")
        speak("The child follows the group.")
        time.sleep(5)
        speak("The same teenager from the previous scene exits his home, a boat house connected to the pier by a small bridge.")
        speak("The crowd is waiting to meet him. It looks like he'll need to talk to a few people before proceeding.")
    elif get_map() == 376:
        speak("Tidus is crossing a bridge in the sky, wide enough for vehicles.")
        speak("He looks up at a digital banner of his father, a hint of disgust crosses his face.")
